...
export default class JiraProjectSyncAction extends LightningElement {
    ...
    accountId = "557058:1f2502f3-6b58-458d-98f5-346deb28b902" // (Adam K.| Admin)  // Changed on: 19-04-23 | By Habib
    totalTask = {
    ...
    resolveDependency() {
        ...
        // let index = 1
        let index = this.phase_records.length;  // Changed on: 19-04-23 | By Habib
        ...
        this.phase_records.forEach(e => {
            ...
            // index++
            index--  // Changed on: 19-04-23 | By Habib
        })
